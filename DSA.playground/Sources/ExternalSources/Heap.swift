...
//    public typealias HeapComparator<T:Comparable> = (_ l:T,_ r:T) -> Bool
//    public var heap = [T]()
...
//    }
//
//    public var comparator:HeapComparator<T>
//
//
...
//    }
//
//    public init(comparator:@escaping HeapComparator<T>) {
